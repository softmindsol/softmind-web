...
export default function EcomOurWork() {
  ...
  return (
    <section className="relative w-full bg-[#161616] text-white py-16 md:py-24 overflow-hidden font-jakarta">
      {/* Central Blue radial background glow */}
      <div
      ...
      <div className="relative mx-auto px-6 md:px-12">
        ...
        <div className="flex flex-col lg:flex-row lg:items-end justify-between items-center lg:items-start gap-8 mb-[47px] text-center lg:text-left">
          ...
          <div className="flex flex-col items-center lg:items-start gap-3.5 max-w-[650px] mx-auto lg:mx-0">
