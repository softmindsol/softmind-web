...
export default function DevelopmentProcess() {
  ...
  return (
    <section className="relative w-full bg-gray-200 py-16 md:py-24 overflow-hidden font-jakarta">
      ...
      <div className="relative mx-auto px-6 md:px-12 max-w-[1240px]">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-start">
          {/* Left: How it Works */}
          <div className="flex flex-col gap-4">
            <div className="flex items-center gap-2">
              <span className="w-2 h-2 rounded-full bg-[linear-gradient(104.04deg,#00235A_8.33%,#004BC0_93.33%)]" />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#0CBF83] to-[#004BC0] text-[22px] font-bold tracking-wide">
                Development Process
              </span>
            </div>
            <h2 className="text-3xl sm:text-4xl lg:text-[40px] lg:leading-[58px] font-bold tracking-wide text-dark max-w-[800px]">
            ...
            {submitted ? (
              <div className="flex flex-col items-center justify-center text-center gap-5 py-12">
                ...
                <p className="text-grey font-medium text-sm leading-relaxed max-w-xs">
                  Thank you! Our eCommerce experts will review your request and
              ...
              >
                ...
                <p className="text-center text-xs text-grey font-medium">
