...
const projects = [
  {
    id: 1,
    tag: "Vitria AI",
    title: "HealthTech Management by Softmind Solutions",
    description:
      "This app is designed to make investing easy and accessible for everyone whether you’re a beginner or an experienced investor. It combines smart technology, strong security, and a simple interface to help users grow their wealth with confidence.",
...
export default HealthTechProjects;
