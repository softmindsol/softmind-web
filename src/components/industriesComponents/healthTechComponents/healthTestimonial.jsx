...
export default function HealthTestimonial() {
      ...
      <div className="mx-auto px-6 lg:px-0 flex flex-col items-center">
        ...
        <div className="flex flex-col items-center gap-3.5 text-center mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-[46px] lg:leading-[58px] font-bold tracking-[1px] capitalize text-dark">
            Trusted by Healthcare and Fitness Innovators
          </h2>
          <p className="max-w-[900px] text-base lg:text-xl font-medium text-gray-600 mt-1">
            The success of our clients speaks for itself. Discover how our
            collaborative approach, technical expertise, and commitment to
            quality have helped healthcare organizations build reliable products
