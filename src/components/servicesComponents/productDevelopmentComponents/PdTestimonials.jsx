...
export default function PdTestimonials() {
  ...
  const getCardPositionStyles = (cardIndex) => {
    ...
    if (diff === 0) {
      return {
        ...
        className:
          "shadow-[0px_4px_30px_rgba(12,191,131,0.3)] opacity-100 border border-[#0CBF83]/50",
      };
    } else if (diff === 1) {
      return {
        style: {
  ...
  return (
    <section className="relative w-full bg-[#111111] text-white py-16 md:py-24 overflow-hidden font-jakarta">
      ...
      <div className="absolute top-0 left-0 w-[400px] h-[400px] bg-[#0CBF83]/5 rounded-full blur-[120px] pointer-events-none" />

      <div className="mx-auto px-6 lg:px-12 max-w-7xl flex flex-col items-center relative z-10">
        {/* Header */}
        <motion.div
          ...
          className="flex flex-col items-center gap-3.5 text-center mb-16 max-w-[860px]"
        >
        ...
        <div className="w-full grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center min-h-[460px]">
          ...
          {/* Content */}
          <div className="lg:col-span-6 flex flex-col justify-center items-center md:items-start space-y-6 max-w-[563px] lg:pl-4">
            <div className="space-y-4">
              <div className="space-y-1 text-center md:text-start">
                <h3 className="text-3xl lg:text-[36px] lg:leading-[45px] font-bold tracking-wide text-white">
                  {testimonials[activeIndex].name}
                </h3>
                <span className="text-base text-[#0CBF83] font-medium tracking-wide block">
              ...
              <div className="flex justify-center md:justify-start items-center gap-1">
                {[...Array(5)].map((_, i) => (
                  <svg
                    ...
                    viewBox="0 0 24 24"
                    fill={
                      i < testimonials[activeIndex].rating ? "#0CBF83" : "#333333"
                    }
            ...
            <div className="min-h-[200px] flex items-start text-center md:text-start">
              <p className="text-sm md:text-base text-white/80 font-medium leading-relaxed italic transition-opacity duration-500">
