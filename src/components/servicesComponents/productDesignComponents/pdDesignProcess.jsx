...
const processSteps = [
  {
    num: "01",
    title: "Discover",
    description: "Understand your business objectives, users, market, competitors, and product challenges.",
  },
  {
    num: "02",
    title: "Research",
    description: "Gather user insights and identify behaviors, pain points, expectations, and opportunities.",
  },
  {
    num: "03",
    title: "Define",
    description: "Translate research into user journeys, information architecture, product requirements, and UX priorities.",
  },
  {
    num: "04",
    title: "Design",
    description: "Create wireframes, UI concepts, high-fidelity designs, and interactive prototypes.",
  },
  {
    num: "05",
    title: "Validate",
    description: "Test designs with users, identify usability issues, and refine the experience before development.",
  },
  {
    num: "06",
    title: "Scale",
    description: "Establish reusable design systems and provide development-ready specifications for consistent implementation.",
  },
];
...
export default function DesignProcess() {
  ...
  return (
    <section className="bg-white py-24 lg:py-32 font-jakarta overflow-hidden" ref={containerRef}>
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-20">
          ...
          <p className="text-[16px] md:text-[18px] text-gray-600 leading-relaxed">
            Our digital product design process connects strategy, research, design, validation, and development to create experiences that deliver real value.
          </p>
        </div>
                ...
                >
                  ...
                  <motion.div
                    ...
                    className={`w-full sm:w-1/2 ${
                      isEven ? "sm:pl-12 lg:pl-20 text-left" : "sm:pr-12 lg:pr-20 sm:text-right text-left"
                    }`}
                  >
                    <div className="bg-white p-8 rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100 hover:shadow-xl transition-shadow duration-300 relative group overflow-hidden">
                      ...
                      <div className="relative z-10">
                        <span className="text-[#0CBF83] text-5xl font-black opacity-20 block mb-4">
                          {step.num}
                        </span>
