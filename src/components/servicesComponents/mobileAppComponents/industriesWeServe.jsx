...
const IndustriesWeServe = () => {
  return (
    <section className="bg-[#161616] w-full font-jakarta py-20 lg:py-28">
          ...
          {industries.map((industry, index) => (
            ...
            >
              ...
              <div className="absolute inset-0 p-8 flex flex-col justify-end">
                ...
                <p className="text-[15px] text-white leading-relaxed opacity-0 group-hover:opacity-100 transform translate-y-4 group-hover:translate-y-0 transition-all duration-300 delay-100">
                  {industry.desc}
                </p>
              </div>
            </div>
