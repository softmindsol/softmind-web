...
const MvpBuildSmarter = () => {
  return (
    <section className="w-full py-20 lg:py-28 bg-gradient-to-b from-white to-gray-50/50">
      <div className="container mx-auto px-6 max-w-7xl">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-blue-50 text-blue-600 font-medium text-sm w-fit border border-blue-100">
              <Lightbulb className="w-4 h-4" />
              <span>Smart MVP Approach</span>
            </div>
            
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 leading-tight">
              Build Smarter With a <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-indigo-600">Data-Driven MVP</span>
            </h2>
            
            <p className="text-lg text-gray-600 leading-relaxed mt-2">
              A successful MVP is more than a product with fewer features. It is a focused version of your product designed to test assumptions, solve a real customer problem, and generate market insights before you make a larger investment.
            </p>

            <div className="flex gap-4 mt-4">
              <div className="flex flex-col p-4 bg-white rounded-2xl shadow-[0_4px_20px_-4px_rgba(0,0,0,0.05)] border border-gray-100 w-1/2">
                <Target className="w-8 h-8 text-indigo-500 mb-3" />
                <h4 className="font-semibold text-gray-900">Laser Focused</h4>
                <p className="text-sm text-gray-500 mt-1">Targeting the most critical user needs.</p>
              </div>
              <div className="flex flex-col p-4 bg-white rounded-2xl shadow-[0_4px_20px_-4px_rgba(0,0,0,0.05)] border border-gray-100 w-1/2">
                <TrendingUp className="w-8 h-8 text-blue-500 mb-3" />
                <h4 className="font-semibold text-gray-900">Insight Driven</h4>
                <p className="text-sm text-gray-500 mt-1">Learning from real market behavior.</p>
              </div>
            </div>
          </motion.div>
          ...
          <motion.div
            ...
            className="bg-white rounded-3xl p-8 lg:p-10 shadow-[0_8px_30px_rgb(0,0,0,0.08)] border border-gray-100 relative overflow-hidden"
          >
