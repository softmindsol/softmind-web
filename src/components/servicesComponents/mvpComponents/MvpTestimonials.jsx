...
export default function MvpTestimonials() {
      ...
      <div className="mx-auto px-6 lg:px-0 flex flex-col items-center relative z-10">
        <div className="flex flex-col items-center gap-3.5 text-center mb-16">
          ...
          <p className="text-center max-w-[850px] text-base text-white/70 font-medium tracking-[1px]">
            From early-stage startups to growing businesses, our clients trust
            Softmind to turn complex ideas into practical, high-performing
            digital products. Hear how our collaborative approach, technical
            expertise, and focus on business outcomes have helped clients move
