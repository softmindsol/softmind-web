      ...
      <div className="relative w-full mx-auto px-6 lg:px-12">
        <div className="flex flex-col items-center text-center space-y-4 mb-16 max-w-[900px] mx-auto">
          ...
          <p className="text-[16px] md:text-[18px] text-grey font-medium leading-[26px]">
            Our custom web application development expertise spans multiple
            industries, helping businesses automate workflows, improve customer
            experiences, integrate critical systems, and scale their digital
            operations with secure, high-performance solutions.
          </p>
        </div>
