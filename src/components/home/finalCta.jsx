...
export default function FinalCta() {
  return (
    <section className="relative w-full bg-white py-16 md:py-24 text-white overflow-hidden font-jakarta">
      {/* Background Accent Ellipse Glows */}
      {/* <div
        className="absolute top-1/2 left-0 -translate-x-1/2 -translate-y-1/2 w-[620px] h-[350px] rounded-full pointer-events-none opacity-35 blur-[120px]"
        style={{ backgroundColor: "navy" }}
      />
      <div
        className="absolute top-[50%] right-[-100px] w-[350px] h-[350px] rounded-full pointer-events-none opacity-0 blur-[130px]"
        style={{ backgroundColor: "#0CBF83" }}
      /> */}

      <div className="relative mx-auto px-6 md:px-12 max-w-[1289px] z-10">
        {/* Banner Card Frame */}
        <div className="bg-gradient-to-bl from-[#00235A]/60 to-[#001433]/90 border border-white/[0.06] rounded-[32px] p-8 md:p-16 flex flex-col lg:flex-row items-center justify-between gap-10 shadow-2xl relative overflow-hidden">
