    ...
    <section className="relative w-full bg-[#161616] text-white py-16 md:py-24 overflow-hidden font-jakarta">
      ...
      <div className="relative w-fit mx-auto px-12">
        <div className="flex flex-col items-center justify-between gap-12 lg:gap-8">
          ...
          <div className="flex flex-col items-center gap-4 max-w-[569px]">
            ...
            <h2 className="text-center text-2xl sm:text-4xl lg:text-[46px] lg:leading-[58px] font-bold tracking-[1px] text-white">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 w-full items-start">
            {/* Left Column containing even indexed items */}
            <div className="flex flex-col gap-4">
              {faqData.map((faq, idx) =>
                idx % 2 === 0 ? renderFaqCard(faq, idx) : null
              )}
            </div>
            {/* Right Column containing odd indexed items */}
            <div className="flex flex-col gap-4">
              {faqData.map((faq, idx) =>
                idx % 2 !== 0 ? renderFaqCard(faq, idx) : null
              )}
